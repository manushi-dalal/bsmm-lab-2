...
the_tate |> 
  dplyr::summarize(
    artist = length(unique(artistId)), 
    min_year = min(year, na.rm = TRUE),
    max_year = max(year, na.rm = TRUE),
    aquisition_start = min(acquisitionYear, na.rm = TRUE),
    aquisition_end = max(acquisitionYear, na.rm = TRUE)
  )
```

The `the_tate` dataset has 3342 unique artists who worked from \_\_\_ to \_\_\_. The works were acquired between the years \_\_\_ and \_\_\_.
